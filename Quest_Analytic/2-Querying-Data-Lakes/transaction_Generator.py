...
""" Lambda function to generate fake credit card transaction data and upload to transaction-ingest-1234567890 ingest S3 bucket
"""
# Ingest bucket name from environment variable = transaction-ingest-1234567890
