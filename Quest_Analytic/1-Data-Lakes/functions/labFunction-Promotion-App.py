...
"""
This function processes cart aggregated data, using cart_aggregated_data.csv, from the input S3 bucket
Aggregates it using  the customer ID, product ID and with a new discounted amount for the total amount of abandon items,
and uploads the result to the output S3 bucket.
"""
# According to lab "input_bucket" and "output_bucket" are "raw-zone-bucket-chukky" and "consumption-zone-bucket-chukky" respectively
