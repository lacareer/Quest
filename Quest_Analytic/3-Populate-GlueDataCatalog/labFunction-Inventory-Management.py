...
""""
Lambda function to generate fake inventory data and upload to S3 bucket adding to the existing inventory data by adding more categories 
like product city and product country.The schema will be updated in the Glue Data Catalog using AWS Glue Crawler and subsequent queries 
can be run in Athena for show the updated data.
"""
